    ...
    <main className="container mx-auto px-6 py-8 text-white">
      ...
      {!useTwilio ? (
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="p-4 bg-gray-800 rounded">
            <h3 className="font-semibold mb-2">Lifetime Vault</h3>
            <p className="text-gray-300">Lifetime access to all lessons, recordings, and mentorship resources.</p>
          </div>
        </div>
      ) : (
        <div className="p-4 bg-gray-800 rounded">
