...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    const { data, error: signUpError } = await supabase.auth.signUp({
      ...
      password,
      options: {
        data: { name, phone }  // Add name and phone to user_metadata [oai_citation:3‡supabase.com](https://supabase.com/docs/reference/javascript/auth-signup#:~:text=const%20,)
      }
    });
    ...
    if (signUpError) {
      ...
      // Optionally, you could redirect to the sign-in page here
    }
  };
