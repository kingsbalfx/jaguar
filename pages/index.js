...
export default function Home() {
  ...
  const visibleMessages = messages.filter((m) => m.segments.includes("all") || m.segments.includes(mode));

  return (
    <main className="flex-grow app-bg">
      <div className="app-content container mx-auto px-6 py-12">
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-300">
                Click continue to register with Gmail and complete subscription flow.
              </p>
            </div>
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="bg-gradient-to-br from-slate-900/70 to-black/70 p-4 rounded ring-2 ring-yellow-400/20">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-1">Community chat (premium & VIP segments)</p>
                    </div>
                    <div className="ml-4">
                    ...
                    {visibleMessages.map((m, i) => (
                      <div key={m.id} className="flex items-center gap-3">
                        <div
                          ...
                          style={{
                            boxShadow: "0 0 10px rgba(250,204,21,0.08), 0 0 20px rgba(99,102,241,0.03)",
                            background: "linear-gradient(90deg, rgba(250,204,21,0.06), rgba(99,102,241,0.03))"
                          }}
                        >
                        ...
                        <div className="flex-1">
                          <span
                            ...
                            style={{
                              background: "linear-gradient(90deg, #facc15, #8b5cf6, #06b6d4)",
                              WebkitBackgroundClip: "text",
                              textShadow: "0 0 8px rgba(139,92,246,0.12), 0 0 12px rgba(6,182,212,0.06)",
                              animation: `glowBlink ${2.6 + (i % 3) * 0.25}s ease-in-out ${i * 0.12}s infinite`
                            }}
                          >
                            {m.text}
                          </span>
                        ...
                        <div
                          ...
                          style={{
                            background: "radial-gradient(circle at 30% 30%, #fff6d8, #f59e0b 30%, #7c3aed 70%)",
                ...
                <div className="mt-2">
                  ...
                  <div className="text-sm text-gray-300">
                    Admin-editable messages will appear here. Manage them from Admin Panel.
                  </div>
                </div>
              </div>
            </div>
      ...
      <style jsx>{`
        @keyframes glowBlink {
          0% { opacity: 0.65; filter: blur(0px); transform: translateY(0); }
          40% { opacity: 1; filter: blur(0.6px); transform: translateY(-1px); }
